package com.example.animeapp.presentation.detailScreen.sideContent.staffList
...
@Composable
fun DisplayStaff(staffList: List<Data>, navController: NavController) {
    ListEditor(listData = staffList, navController = navController)
}


@Composable
fun ListEditor(listData: List<Data>, navController: NavController) {
