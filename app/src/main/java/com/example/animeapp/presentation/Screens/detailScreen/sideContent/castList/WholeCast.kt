...
@Composable
fun SingleCharacterMember(character: com.example.animeapp.domain.models.castModel.Character, role: String, navController: NavController) {
//    character.name
...
@Composable
fun SinglePersonMember(person: com.example.animeapp.domain.models.castModel.Person, language: String, navController: NavController) {
//    person.name
//    person.images.jpg
//    person.mal_id
//    person.url
