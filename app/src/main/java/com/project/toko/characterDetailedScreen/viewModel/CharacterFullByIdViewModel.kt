...
class CharacterFullByIdViewModel @Inject constructor(private val malApiService: MalApiService) :
    ...
    private val picturesCache =
        mutableMapOf<Int, List<com.project.toko.characterDetailedScreen.model.characterPicture.Data>>()
    private val _picturesList =
        MutableStateFlow<List<com.project.toko.characterDetailedScreen.model.characterPicture.Data>>(
            emptyList()
        )
