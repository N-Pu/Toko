package com.project.toko.savedScreen.ui.fragment
...
import com.project.toko.savedScreen.ui.screen.DaoScreen
                    ...
                    drawerContent = {
                        ...
                        ShowDrawerContent(imageLoader = imageLoader,
                            ...
                            modifier = Modifier
                                .fillMaxHeight()
                                .fillMaxWidth(0.9f),
                            toggleSFW = { randomScreenViewModel.toggleSFW()},
                            toggleState = {
                                randomScreenViewModel.sfwState
                            }
                        )
                    }
                ) {
