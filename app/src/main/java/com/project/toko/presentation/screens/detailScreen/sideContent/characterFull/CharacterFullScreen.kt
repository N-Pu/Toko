package com.project.toko.presentation.screens.detailScreen.sideContent.characterFull
...
fun DisplayHorizontalPagerWithIndicator(
    painterList: List<com.project.toko.domain.models.characterPictures.Data>,
    modifier: Modifier
) {
...
fun DisplayKanjiAndEnglishName(
    data: com.project.toko.domain.models.characterModel.Data,
    modifier: Modifier,
) {
